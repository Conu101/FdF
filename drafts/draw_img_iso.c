...
/*   Updated: 2022/05/06 12:07:06 by ctrouve          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Draw image in case of ISO projection


static void	reset_background(void *mlx_ptr, void *win_ptr, t_map *map, int color)
{
	int	x;
	int	y;
...
void	draw_img_iso(t_map *map, t_fdf *fdf)
{
	...
	//reset_background(fdf->mlx, fdf->win, map, 0x000000);
	y = 0;
	while (y <= map->height - 1)
	{
		x = 0;
